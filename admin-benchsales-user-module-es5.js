...
var DocumentBenchListComponent = /** @class */ (function () {
    ...
    DocumentBenchListComponent.prototype.getColor = function (status) {
        if (status == "S") {
            return "#d4edda";
        }
    };
...
module.exports = ":host ::ng-deep .p-cell-editing {\n  padding-top: 0 !important;\n  padding-bottom: 0 !important;\n}\n\n.disable-td {\n  pointer-events: none;\n}\n\n.btn-length {\n  margin-right: 5px;\n}\n/*# sourceMappingURL=data:application/json;base64, */"
...
var HotListBenchComponent = /** @class */ (function () {
    ...
    HotListBenchComponent.prototype.ngOnInit = function () {
        ...
        this.exportColumns = this.colsex.map(function (col) { return ({ title: col.header, dataKey: col.field }); });
    };
    /*
      exportExcel() {
    ...
    HotListBenchComponent.prototype.exportPdf = function () {
        //const doc = new jsPDF();
...
var InterviewBenchComponent = /** @class */ (function () {
    ...
    InterviewBenchComponent.prototype.getColor = function (status) {
        if (status == "Placed") {
            return "#d4edda";
        }
    };
...
var MyBenchSalesComponent = /** @class */ (function () {
    function MyBenchSalesComponent(confirmation, fb, messageService, route, userRest, router) {
        this.confirmation = confirmation;
        this.fb = fb;
        this.messageService = messageService;
        this.route = route;
    ...
    ;
    MyBenchSalesComponent.prototype.clearFilters = function (dt) {
        dt.reset(); // reset the table
        this.selectedCity = '';
        this.selectedStatus = '';
    };
    MyBenchSalesComponent.prototype.loadCarsLazy = function (event) {
        var _this = this;
        ...
        setTimeout(function () {
            _this.userRest.getMySubmissions((event)).subscribe(function (response) {
    ...
    MyBenchSalesComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.cities = [];
    ...
    MyBenchSalesComponent.prototype.showModalDialog = function (data) {
        console.log(data);
    ...
    MyBenchSalesComponent.prototype.showModalDialog1 = function (data) {
        this.displayModal1 = true;
        this.comment = data;
    };
    MyBenchSalesComponent.prototype.formatDate = function (date) {
        if (date) {
            var d = new Date(date);
    ...
    MyBenchSalesComponent.prototype.onRepresentativeChange = function (event) {
        if (event.value) {
            console.log(event.value);
            this.table.filter(event.value, 'technology', 'in');
        }
    };
    MyBenchSalesComponent.prototype.dropDatabase = function (event, index) {
        var _this = this;
        if (event.defaultPrevented)
            return;
        event.preventDefault();
    ...
    MyBenchSalesComponent.prototype._dropDatabase = function (index) {
        var _this = this;
        var formData = new FormData();
        formData.append("index", index);
        console.log(formData);
    ...
    MyBenchSalesComponent.prototype.getColor = function (status) {
        if (status == "Placed") {
            return "#d4edda";
        }
    };
    MyBenchSalesComponent.prototype.onDateSelect = function (value) {
        this.table.filter(value, 'created_at', 'equals');
    };
    MyBenchSalesComponent.prototype.formatDateNew = function (date) {
        var month = date.getMonth() + 1;
        var day = date.getDate();
        if (month < 10) {
            month = '0' + month;
    ...
    Object.defineProperty(MyBenchSalesComponent.prototype, "vendorStatus", {
        get: function () { return this.registerVendor.get('vendorStatus'); },
        enumerable: true,
        configurable: true
    });
    Object.defineProperty(MyBenchSalesComponent.prototype, "vendorComments", {
        get: function () { return this.registerVendor.get('vendorComments'); },
        enumerable: true,
        configurable: true
    });
    Object.defineProperty(MyBenchSalesComponent.prototype, "scheduleDate", {
        get: function () { return this.registerVendor.get('scheduleDate'); },
        enumerable: true,
        configurable: true
    });
    Object.defineProperty(MyBenchSalesComponent.prototype, "timezone", {
        get: function () { return this.registerVendor.get('timezone'); },
        enumerable: true,
        configurable: true
    });
    MyBenchSalesComponent.prototype.registerUser = function (submissionId) {
        var _this = this;
...
var UserListComponent = /** @class */ (function () {
    ...
    UserListComponent.prototype.getColor = function (status) {
        if (status == "Placed") {
            return "#d4edda";
        }
    };
...
var UserRestService = /** @class */ (function () {
    ...
    UserRestService.prototype.getMySubmissions = function (page) {
        var pagenumber = page.first / 20;
        var str;
        var actorList = page.filters;
        var params = new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpParams"]();
...
/* harmony import */ var primeng_inputmask__WEBPACK_IMPORTED_MODULE_35__ = __webpack_require__(/*! primeng/inputmask */ "./node_modules/primeng/inputmask.js");
/* harmony import */ var primeng_inputmask__WEBPACK_IMPORTED_MODULE_35___default = /*#__PURE__*/__webpack_require__.n(primeng_inputmask__WEBPACK_IMPORTED_MODULE_35__);
    ...
    UserModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
            ...
            imports: [
                ...
                primeng_inputtext__WEBPACK_IMPORTED_MODULE_19__["InputTextModule"], primeng_confirmdialog__WEBPACK_IMPORTED_MODULE_27__["ConfirmDialogModule"], primeng_inputmask__WEBPACK_IMPORTED_MODULE_35__["InputMaskModule"],
...
var ReplacePipe = /** @class */ (function () {
    ...
    ReplacePipe.prototype.transform = function (value, strToReplace, replacementStr) {
