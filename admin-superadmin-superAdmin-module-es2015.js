...
let ConsultantListComponent = class ConsultantListComponent {
    ...
    _createPortal(index) {
        ...
        formData.append("index", index);
        console.log(formData);
        this.userRest.createEmployeePortal(formData).subscribe((response) => {
            console.log(response);
            this.loading = false;
...
let DocumentsInactiveComponent = class DocumentsInactiveComponent {
    ...
    ngOnInit() {
        ...
        this.userRest.getConsultantsInactive().subscribe((response) => { console.log(this.timeSheets = response.timesheet); this.loading = false; }, (error) => { console.log(error); });
        this.frozenCols = [
            { field: 'consultatName', header: 'Name' },
        ];
        this.scrollableCols = [
...
let DocumentsPlacedComponent = class DocumentsPlacedComponent {
    constructor(confirmation, fb, messageService, route, userRest, router) {
        this.confirmation = confirmation;
        this.fb = fb;
        this.messageService = messageService;
    ...
    ngOnInit() {
        ...
        this.userRest.getConsultantsPlaced().subscribe((response) => { console.log(this.timeSheets = response.timesheet); this.loading = false; }, (error) => { console.log(error); });
        this.frozenCols = [
            { field: 'consultatName', header: 'Name' },
        ];
        this.scrollableCols = [
...
let EmailRestService = class EmailRestService {
    constructor(http) {
        this.http = http;
        this.users = [];
    }
...
let HotListComponent = class HotListComponent {
    ...
    ngOnInit() {
        ...
        this.exportColumns = this.colsax.map(col => ({ title: col.header, dataKey: (col.field) }));
    }
    /*
      exportExcel() {
...
let InterviewComponent = class InterviewComponent {
    ...
    ngOnInit() {
        this.userRest.getConsultants().subscribe((response) => { console.log(this.interviewschedules = response.submissions); this.loading = false; }, (error) => { console.log(error); });
        this.scrollableCols = [
            // { field: 'user_details.name', header: 'Created By', width: '20%',editable: false},
            // { field: 'consultant.consultatName', header: 'Consultant Name', width: '20%',editable: false},
...
/* harmony import */ var _kolkov_angular_editor__WEBPACK_IMPORTED_MODULE_38__ = __webpack_require__(/*! @kolkov/angular-editor */ "./node_modules/@kolkov/angular-editor/fesm2015/kolkov-angular-editor.js");
...
let ReplaceAdminPipe = class ReplaceAdminPipe {
