...
var InterviewPipe = /** @class */ (function () {
    /**
     *
     */
    function InterviewPipe() {
    }
    InterviewPipe.prototype.transform = function (value) {
        var args = [];
...
var InterviewRestService = /** @class */ (function () {
    function InterviewRestService(http) {
        this.http = http;
        this.users = [];
    }
...
var UserListComponent = /** @class */ (function () {
    function UserListComponent(confirmation, fb, messageService, route, restService, router) {
    ...
    UserListComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.restService.getConsultants().subscribe(function (response) { console.log(_this.timeSheets = response.submissions); _this.loading = false; }, function (error) { console.log(error); });
        this.frozenCols = [
    ...
    UserListComponent.prototype._dropDatabase = function (index) {
        ...
        this.restService.statusChangeConsultant(formData).subscribe(function (response) {
...
//# sourceMappingURL=admin-interviews-interviews-module-es5.js.map